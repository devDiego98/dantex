...
const highlights = [
  { label: "Salud & Life Sciences", icon: HeartPulse },
  { label: "Datos clínicos", icon: Microscope },
  { label: "Cumplimiento", icon: Activity },
] as const;
  ...
  return (
    <section className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center px-4 text-center sm:px-6 lg:px-8">
        <motion.p
          {...fadeUp}
          className="font-chakra mb-4 text-xs font-semibold uppercase tracking-[0.25em] text-rose-200/85"
        >
          Industrias · Salud
        </motion.p>
        ...
        >
          Innovación tecnológica para el futuro de la salud
        </motion.h1>
        ...
        >
          Diseñamos plataformas de IA seguras para salud &amp; life sciences,
          transformando datos en mejores resultados.
        </motion.p>
        ...
        >
          {highlights.map((h) => (
            ...
            >
              <h.icon className="size-4 text-rose-200/90" aria-hidden />
              {h.label}
            </span>
          ))}
        </motion.div>
