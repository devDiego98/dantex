  ...
  return (
    <section className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center px-4 text-center sm:px-6 lg:px-8">
        <motion.p
          {...fadeUp}
          className="font-chakra mb-4 text-xs font-semibold uppercase tracking-[0.25em] text-sky-200/80"
        >
          Industrias · Finanzas
        </motion.p>
        ...
        >
          Soluciones financieras preparadas
          <br className="hidden sm:block" /> para el futuro
        </motion.h1>
        ...
        >
          Ayudamos a las empresas a transformar operaciones y crear soluciones
        ...
        >
          {highlights.map((h) => (
            ...
            >
              <h.icon className="size-4 text-sky-200/90" aria-hidden />
              {h.label}
            </span>
          ))}
        </motion.div>
