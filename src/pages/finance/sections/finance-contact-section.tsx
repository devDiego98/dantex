...
export function FinanceContactSection() {
  return (
    <section id="contact" className={sectionPadding}>
      <motion.div
        className="mx-auto w-full max-w-5xl overflow-hidden rounded-3xl border border-sky-500/25 bg-gradient-to-br from-sky-700/55 via-sky-950/65 to-black p-6 shadow-[0_0_90px_rgba(56,189,248,0.14)] sm:p-10 lg:p-12"
        {...fadeUp}
      >
        <div className="grid gap-10 lg:grid-cols-[1fr_1.05fr] lg:gap-12">
          <div className="text-white">
            ...
            <p className="mt-3 text-sm leading-relaxed text-sky-50/90">
            ...
            <ul className="mt-8 grid gap-2.5 text-sm text-sky-50/95 sm:grid-cols-2">
              {pillars.map((p) => (
                <li
                  key={p}
          ...
          >
            ...
            <label className="block text-xs font-medium text-zinc-200">
              ...
              <textarea
                name="message"
                rows={4}
                className="mt-1.5 w-full resize-y rounded-lg border border-white/15 bg-black/50 px-2.5 py-2 text-sm text-zinc-100 outline-none placeholder:text-zinc-500 focus-visible:border-sky-400/50 focus-visible:ring-2 focus-visible:ring-sky-500/30"
              />
            </label>
