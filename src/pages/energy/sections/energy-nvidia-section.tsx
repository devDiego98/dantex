...
export function EnergyNvidiaSection() {
  return (
    <section className={cn(sectionPadding, "pb-6")}>
      <motion.div
        className="mx-auto grid w-full max-w-5xl gap-10 overflow-hidden rounded-3xl border border-emerald-500/20 bg-gradient-to-br from-zinc-950 via-black to-zinc-950 p-8 shadow-[0_0_80px_-20px_rgba(16,185,129,0.22)] sm:grid-cols-[auto_1fr] sm:gap-14 sm:p-12"
        {...fadeUp}
      >
        ...
        <div className="text-left">
          ...
          <p className="mt-4 text-pretty leading-relaxed text-zinc-400">
            Explora e implementa soluciones de IA para optimizar las operaciones,
            mejorar la eficiencia de los recursos y construir sistemas energéticos
            más resilientes.
          </p>
          <div className="mt-7">
            <a
              ...
              className={cn(
                ...
                "rounded-full border-emerald-400/35 bg-black/30 text-sm font-medium text-white hover:bg-emerald-500/10"
              )}
            >
